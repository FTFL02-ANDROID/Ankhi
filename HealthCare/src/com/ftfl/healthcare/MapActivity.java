...
import com.ftfl.healthcare.database.HealthDBHelper;
...
public class MapActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sqlSource = new HealthDBSource(this);
			...
			if (value > 0) {
				...
				if (cursor.moveToFirst()) {
					...
					name = cursor.getString(cursor
							.getColumnIndex(HealthDBHelper.COL_HEALTH_PROFILE_HOSPITAL_NAME));
					String lat = cursor
							.getString(cursor
									.getColumnIndex(HealthDBHelper.COL_HEALTH_PROFILE_LATITUDE));
					String lngt = cursor
							.getString(cursor
									.getColumnIndex(HealthDBHelper.COL_HEALTH_PROFILE_LONGTITUDE));
					address = cursor
							.getString(cursor
									.getColumnIndex(HealthDBHelper.COL_HEALTH_PROFILE_HOSPITAL_ADDRESS));
